...
<%--						<ul>--%>
<%--							--%>
<%--&lt;%&ndash;							<li><a href="${pageContext.request.contextPath }/register.jsp">注册</a></li><b></b>							&ndash;%&gt;--%>
<%--&lt;%&ndash;							<li><a href="${pageContext.request.contextPath }/forgetPsw.jsp">忘记密码</a></li>							&ndash;%&gt;--%>
<%--						</ul>--%>
<%--					</div>--%>
				</div>
			</form>				
