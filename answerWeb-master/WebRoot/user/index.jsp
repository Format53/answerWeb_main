			...
			<div class="">
				<div class="info">
					<ul>
						...
						<li class="alter" id="showFalseBook" onclick="showFalseBook()">
							<a href="${pageContext.request.contextPath}/user/showFalseBook" style="text-decoration: none;color: white">
								错题本
							</a>
						</li>
					</ul>
...
<%--function showFalseBook(){--%>
<%--	//转到错题本页面--%>
<%--	$.ajax({--%>
<%--		url: "${pageContext.request.contextPath}/user/showFalseBook",--%>
<%--	});--%>
<%--	return false;--%>
<%--}--%>
